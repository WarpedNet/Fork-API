async function createFork(creatorID, parentID, recipeName, recipeDesc, recipeMethod, bannerImg, icon, res) {
    const db = require('../db');
    ...
    res.status(200).send("New Fork Created!")
}
