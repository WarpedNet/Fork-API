async function createFork(creatorID, parentID, recipeName, recipeDesc, recipeMethod, bannerImg, img, icon) {
    ...
    const addFork = new PS({name: "add-fork", text: "INSERT INTO forks(customer_id, name, description, method, banner, icon, img, count) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id"});
    ...
    const newForkID = await db.one(addFork, [creatorID, recipeName, recipeDesc, recipeMethod, bannerImg, icon, img, 0], u => u.fork_id);
